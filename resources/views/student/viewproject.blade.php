                ...
                <div class="col-md-12 mb-4">
                    <div class="card text-left">
                         <div class="card-header text-right bg-transparent">
                            <a type="button"  class="btn btn-primary btn-md m-1" href="/project/create"><i class="i-Add-User text-white mr-2"></i> Add Project</a>
                        </div>
                        <div class="card-body">
                            <h2 class="card-title mb-3"> Project Details</h2>

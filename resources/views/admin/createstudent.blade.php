    ...
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3"> Add Student</div>
                        <form action="{{ route('storestudent') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group mb-3">
                                    ...
                                    <input type="roll_no" class="form-control @error('roll_no') is-invalid @enderror" value="{{old('roll_no')}}" id="roll_no" placeholder="8080"  minlength="4" maxlength="4" 
